...
export default [
  ...
  route(ROUTE_NAMES.DASHBOARD, "routes/dashboard.tsx", [
    ...
    route(ROUTE_NAMES.SUBSCRIPTION, "routes/dashboard/subscription.tsx"),
    route(ROUTE_NAMES.SUBSCRIPTION_PAYMENT, "routes/dashboard/subscription.payment.tsx"),
    route(ROUTE_NAMES.SUBSCRIPTION_SUCCESS, "routes/dashboard/subscription.success.tsx"),
