export const es = {
  common: {
    ...
    sendCodeError: "Error al enviar código. Intente nuevamente.",
    resetPasswordError: "Error al redefinir contraseña. Intente nuevamente.",
    loginError: "Error al iniciar sesión. Intente nuevamente.",
    invalidCredentials: "Email o contraseña inválidos, o usuario inactivo",
  ...
  sidebar: {
    ...
    productionIndexes: "Índices de Producción",
  ...
  inventory: {
    ...
    new: {
      ...
      nitrogenContent: "Contenido de Nitrógeno",
      nitrogenContentLabel: "Contenido de Nitrógeno (kg por unidad)",
      nitrogenContentInvalid:
        "El contenido de nitrógeno debe ser un número válido mayor o igual a cero",
      usageBasisOptions: {
  ...
  animals: {
    ...
    details: {
      ...
      dashboard: {
        ...
        costPerArroba: "Costo por arroba",
  ...
  acquisitions: {
    new: {
      ...
      selectSupplier: "Seleccione el proveedor",
      searchSupplier: "Buscar proveedor...",
      pricingMode: "Modo de Precios",
      ...
      fees: "Tasas y Cargos",
      addFee: "Agregar Tasa",
      feeName: "Nombre de la Tasa",
      feeNamePlaceholder: "Ej: Tasa de Transporte",
      feeAmount: "Monto",
      pricePerAnimal: "Precio por animal",
      costPerArroba: "Costo por Arroba",
      weightInArrobas: "Peso en arrobas",
    ...
    edit: {
      title: "Editar Adquisición",
      description: "Actualizar datos de la adquisición",
    },
    table: {
      supplier: "Proveedor",
      paymentMethod: "Pago",
    ...
    success: {
      updated: "Adquisición actualizada con éxito",
    },
    errors: {
      loadFailed: "Error al cargar adquisición",
      updateFailed: "Error al actualizar adquisición",
    },
    notFound: "Adquisición no encontrada",
  },
  ...
  reproductiveIndexes: {
    ...
    weaningRate: {
      title: "Tasa de Destete",
      description: "Porcentaje de terneros destetados en relación a las hembras expuestas",
      weanedCalves: "Terneros Destetados",
      exposedFemales: "Hembras Expuestas",
    },
    weaningRatio: {
      title: "Relación de Destete",
      description: "Porcentaje del peso del ternero destetado en relación al peso de la madre",
      weanedCalfWeight: "Peso del Ternero Destetado",
      motherWeight: "Peso de la Madre",
      pairs: "Pares",
    },
    kgWeanedCalfPerExposedCow: {
      title: "Kg de Ternero Destetado por Vaca Expuesta",
      description: "Producción de peso de terneros destetados por vaca expuesta",
      totalWeanedWeight: "Peso Total Destetado",
      weanedCalves: "Terneros Destetados",
      exposedFemales: "Hembras Expuestas",
    },
    mortalityRate: {
      title: "Tasa de Mortalidad General",
      description: "Porcentaje de animales muertos en relación al total",
      deadAnimals: "Animales Muertos",
      totalAnimals: "Total de Animales",
    },
    calfMortalityRate: {
      title: "Tasa de Mortalidad de Terneros",
      description: "Porcentaje de terneros muertos en relación al total nacido",
      deadCalves: "Terneros Muertos",
      totalCalves: "Total de Terneros",
    },
    charts: {
      ...
      expectedBirths: "Nacimientos Esperados",
      monthlyCalfMortality: "Tasa de Mortalidad de Terneros Mensual",
      calfMortalityRate: "Tasa de Mortalidad de Terneros (%)",
      noData: "No hay datos disponibles",
    },
  },
  productionIndexes: {
    meta: {
      title: "Índices de Producción - Boi na Nuvem",
      description: "Índices de producción consolidados",
    },
    filters: {
      startDate: "Fecha Inicial",
      endDate: "Fecha Final",
    ...
    averageDailyGain: {
      ...
      description: "Ganancia de peso media diaria de los animales",
      animals: "Animales",
    },
    averageDailyCarcassGain: {
      title: "Ganancia Media Diaria de Canal (GMDC)",
      description: "Ganancia de peso de canal media diaria",
      carcassYield: "Rendimiento de Canal",
    },
    daysOnFeed: {
      title: "Días en Confinamiento",
      description: "Número de días que el animal permaneció en confinamiento hasta el sacrificio",
      animals: "Animales",
    },
    carcassYield: {
      title: "Rendimiento de Canal",
      description: "Porcentaje de peso de canal en relación al peso vivo",
      count: "Cantidad",
      carcassWeight: "Peso de Canal",
      liveWeight: "Peso Vivo",
    },
    slaughterAge: {
      title: "Edad al Sacrificio",
      description: "Edad media de los animales al sacrificio",
      min: "Mínimo",
      max: "Máximo",
      count: "Cantidad",
    },
    arrobaProductionPerHectare: {
      title: "Producción de Arroba por Hectárea",
      description: "Producción de arrobas por hectárea de área",
      totalArrobas: "Total de Arrobas",
      areaInHectares: "Área en Hectáreas",
    },
    kgNitrogenPerAU: {
      title: "Kg de Nitrógeno por UA",
      description: "Cantidad de nitrógeno aplicado por unidad animal",
      totalNitrogen: "Total de Nitrógeno",
      animalUnits: "Unidades Animales",
    },
    kgMeatPerKgNitrogen: {
      title: "Kg de Carne por Kg de N Aplicado",
      description: "Producción de carne por kilogramo de nitrógeno aplicado",
  ...
  profile: {
    ...
    errors: {
      ...
      cpfMustHave11Digits: "CPF debe tener 11 dígitos",
    },
  },
