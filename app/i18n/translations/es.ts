export const es = {
  common: {
    ...
    months: "meses",
    today: "Hoy",
    daysAgo: (days: number) => (days === 0 ? "Hoy" : days === 1 ? "Hace 1 día" : `Hace ${days} días`),
  ...
  locations: {
    ...
    details: {
      ...
      noObservationsWithSearch: (search: string) => `No se encontraron observaciones para "${search}"`,
  ...
  acquisitions: {
    new: {
      ...
      motherRegistrationNumberPlaceholder: "Ingrese el número de registro (si no es de la propiedad)",
      fatherRegistrationNumberPlaceholder: "Ingrese el número de registro (si no es de la propiedad)",
