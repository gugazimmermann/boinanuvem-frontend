import type { SupplierObservation, SupplierObservationFormData } from "~/types/supplier-observation";
...
export const mockSupplierObservations: SupplierObservation[] = [
  {
    ...
    observation: "Fornecedor apresentou excelente qualidade nos produtos entregues. Prazo de entrega respeitado.",
  ...
  },
  {
    id: "sup-obs-002",
    supplierId: "990e8400-e29b-41d4-a716-446655440010",
    observation: "Reunião de avaliação de desempenho realizada. Fornecedor atendeu todos os critérios de qualidade. Contrato renovado.",
  ...
  },
  {
    ...
    observation: "Fornecedor demonstrou flexibilidade em negociação de preços. Condições comerciais favoráveis acordadas.",
    fileIds: [],
  ...
  },
  {
    id: "sup-obs-004",
    supplierId: "990e8400-e29b-41d4-a716-446655440011",
    observation: "Avaliação de produtos recebidos. Qualidade dentro dos padrões estabelecidos. Certificados de qualidade anexados.",
...
export function getSupplierObservationsBySupplierId(
  supplierId: string
): SupplierObservation[] {
...
export function addSupplierObservation(
