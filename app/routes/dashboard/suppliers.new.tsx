...
import type { SupplierFormData, Property } from "~/types";
...
export default function NewSupplier() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      showAlert(t.suppliers.new.success, "success");
      setTimeout(() => {
        navigate(ROUTES.SUPPLIERS);
      }, 1500);
    } catch (error) {
      console.error("Error adding supplier:", error);
      showAlert(t.suppliers.new.error, "error");
    } finally {
        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          <div className="space-y-4">
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
              ...
              />
              <Input
                label={t.suppliers.new.nameLabel}
                value={formData.name}
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              <Input
                label={t.suppliers.new.cpfLabel}
                value={formData.cpf}
              ...
              />
              <Input
                label={t.suppliers.new.cnpjLabel}
                value={formData.cnpj}
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
              <Input
                label={t.suppliers.new.emailLabel}
                type="email"
              ...
              />
              <Input
                label={t.suppliers.new.phoneLabel}
          ...
          <div className="flex justify-end gap-3 pt-4 border-t border-gray-200 dark:border-gray-700">
            ...
            <Button type="submit" variant="primary" disabled={isSubmitting}>
              {isSubmitting ? t.common.loading : t.suppliers.new.addButton}
            </Button>
          </div>
        </form>
      </div>
