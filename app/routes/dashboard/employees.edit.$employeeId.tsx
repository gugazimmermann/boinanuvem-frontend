...
export default function EditEmployee() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (success) {
        showAlert(t.employees.success.updated, "success");
        setTimeout(() => {
          navigate(ROUTES.EMPLOYEES);
        }, 1500);
      } else {
        showAlert(t.employees.errors.updateFailed, "error");
      }
    } catch (error) {
        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          <div className="space-y-4">
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
              ...
              />
              <Input
                label={t.employees.edit.nameLabel}
                value={formData.name}
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
              <Input
                label={t.employees.edit.cpfLabel}
                value={formData.cpf}
              ...
              />
              <Input
                label={t.employees.edit.emailLabel}
                type="email"
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
              <Input
                label={t.employees.edit.phoneLabel}
          ...
          <div className="flex justify-end gap-3 pt-4 border-t border-gray-200 dark:border-gray-700">
            ...
            <Button type="submit" variant="primary" disabled={isSubmitting}>
              {isSubmitting ? t.common.loading : t.employees.edit.save}
            </Button>
          </div>
        </form>
      </div>
