...
vi.mock("~/components/ui", () => ({
  Input: ({ label, placeholder, value, onChange, showPasswordToggle, ...props }: any) => (
    <input
...
describe("NewTeamMember", () => {
  ...
  it("should handle successful form submission", () => {
    ...
    const passwordInput = screen.queryByTestId("input-Password") || inputs.find(inp => inp.getAttribute("type") === "password");
  ...
  it("should validate password confirmation", () => {
    ...
    const passwordInput = screen.queryByTestId("input-Password") || screen.queryByPlaceholderText(/Senha/i);
    const confirmPasswordInput = screen.queryByTestId("input-ConfirmPassword") || screen.queryByPlaceholderText(/Confirmar/i);
