...
import EditSupplier from "../suppliers.edit.$supplierId";
...
describe("EditSupplier", () => {
  ...
  const createRouter = (supplierId: string) => {
    return createMemoryRouter(
      [
        {
          path: "/dashboard/suppliers/:supplierId/edit",
          element: (
            <LanguageProvider>
              <ThemeProvider>
                <EditSupplier />
      ...
      {
        initialEntries: [`/dashboard/suppliers/${supplierId}/edit`],
      }
    );
  };
  ...
  it("should render edit supplier form with pre-filled data", async () => {
  ...
  it("should handle form submission", async () => {
    vi.mocked(updateSupplier).mockReturnValue(true);
    const router = createRouter("supplier-1");
    render(<RouterProvider router={router} />);
  ...
  it("should have correct meta function", () => {
    expect(EditSupplier).toBeDefined();
  });
  ...
  it("should pre-fill form with supplier data", async () => {
    const router = createRouter("supplier-1");
    render(<RouterProvider router={router} />);
