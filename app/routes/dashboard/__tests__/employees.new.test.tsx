...
describe("NewEmployee", () => {
  ...
  it("should handle successful form submission", () => {
    ...
    const phoneInput =
      ...
      inputs.find((inp) => String(inp.getAttribute("aria-label") ?? "").includes("Telefone"));
  ...
  it("should handle form submission error", () => {
    vi.mocked(addEmployee).mockReturnValueOnce(
      undefined as unknown as ReturnType<typeof addEmployee>
    );
    const router = createRouter();
    const { container } = render(<RouterProvider router={router} />);
